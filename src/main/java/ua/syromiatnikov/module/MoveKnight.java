...
public class MoveKnight {
    private  static String X = "ABCDEFGH";
    private  static String Y = "12345678";
    ...
    static boolean checkOnTheMove(String currentCell, String nextCell) {
        ...
        int xDiff = findЕTheDifference(current.charAt(0), next.charAt(0), MoveKnight.X);
        int yDiff = findЕTheDifference(current.charAt(1), next.charAt(1), MoveKnight.Y);
